...
public class Sphere implements Surface{
	...
	public float greenLight(Ray ray, LightSource light) {
		...
		Vector3 vl = ray.getVector().addVector3(l);
		...
		System.out.println(n.dotProduct(h));
		return (float) ((float) ks*Math.pow(Math.max(0, -n.dotProduct(h)), 1/surface.getSpecularPower()));
